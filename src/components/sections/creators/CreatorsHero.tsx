  ...
  return (
    <section className="min-h-screen flex items-center px-6 md:px-10 lg:px-24 relative pt-32">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1200px] h-[700px] bg-purple-600 opacity-[0.08] blur-[150px] rounded-full mix-blend-screen"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[900px] h-[900px] bg-pink-600 opacity-[0.06] blur-[180px] rounded-full mix-blend-screen"></div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto w-full grid lg:grid-cols-[1.1fr_0.9fr] items-center gap-16 z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-10 shadow-lg">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white">
              <Instagram size={16} />
            </span>
            <span className="text-[11px] font-bold tracking-[0.2em] text-slate-300 uppercase">For Instagram Creators</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold mb-8 tracking-tighter leading-[0.95] text-metallic drop-shadow-2xl">
            Stop Renting <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-rose-500 to-orange-500">Your Audience</span>
          </h1>
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-12 font-light leading-relaxed max-w-xl mx-auto lg:mx-0 border-l border-slate-700/50 pl-8">
            The algorithm is volatile. Likes don't pay the bills. Move your top followers into a community you actually own.
          </p>
