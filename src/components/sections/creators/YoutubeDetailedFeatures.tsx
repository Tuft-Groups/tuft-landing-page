...
const YOUTUBE_CREATOR_FEATURES: Feature[] = [
  {
    id: "reach",
    tag: "Ownership",
    accent: "#EF4444",
    ...
    titleSecond: "No Notification Bell Needed.",
    description:
      "Stop hoping your subscribers click the bell icon. On Tuft, everyone gets a notification when you post an update, behind-the-scenes content, or an announcement. No shadowbanning, just direct access.",
    badges: [
      { icon: BellBold, text: "Direct Push Alerts" },
      { icon: CheckCircleBold, text: "Guaranteed Reach" },
      { icon: EyeBold, text: "No Feed Algorithm" },
    ],
  ...
  },
  {
    ...
    color: "tuft-purple",
    titleFirst: "Income,",
    titleSecond: "Independent of AdSense.",
    description:
      "Demonetization won't affect you anymore. Stop losing 30% to YouTube Channel Memberships (Join button). Launch paid memberships, sell exclusive courses, and keep 100% of your earnings.",
    badges: [
  ...
  },
  {
    ...
    color: "tuft-pink",
    titleFirst: "Content,",
    titleSecond: "Organized & Exclusive.",
    description:
      "YouTube is great for discovery, but bad for structured learning. Build a library of premium courses, digital downloads, and resources that your true fans can access easily.",
    badges: [
      { icon: DocumentTextBold, text: "Resource Library" },
      { icon: TagBold, text: "Exclusive Material" },
      { icon: WidgetBold, text: "Structured Content" },
    ],
  ...
  },
  {
    ...
    color: "tuft-purple",
    titleFirst: "Fans,",
    titleSecond: "Beyond the Comments Section.",
    description:
      "YouTube comments are chaotic and limited. Give your most loyal viewers a real community with organized chat threads, AMAs, and deeper connections with each other.",
    badges: [
...
export function YoutubeDetailedFeatures() {
  ...
  const activeFeature = YOUTUBE_CREATOR_FEATURES.find((f) => f.id === activeId);
    ...
    <section id="features" ref={containerRef} className="max-w-[1400px] mx-auto px-6 md:px-12 py-10 md:py-24 relative">
      <div className="flex flex-col md:flex-row gap-16 md:gap-32">
        ...
        <div className="w-full md:w-1/2 space-y-[45vh] md:space-y-[65vh] pb-[20vh] md:pb-[30vh] relative pl-10 md:pl-0">
          ...
          {YOUTUBE_CREATOR_FEATURES.map((feature) => (
          ...
          <div className="sticky top-0 h-screen flex items-center justify-center perspective-[2500px]">
            ...
            <div className="w-[320px] lg:w-[360px] h-[650px] lg:h-[740px] relative transform-style-3d transition-transform duration-100 ease-out">
              <div className="absolute inset-0 rounded-[44px] overflow-hidden bg-black shadow-[0_0_0_2px_#333,0_0_0_4px_#1a1a1a,0_50px_100px_-20px_rgba(0,0,0,0.8)]">
                ...
                <img
                  src={YOUTUBE_CREATOR_FEATURES.find((f) => f.id === activeId)?.mockup}
